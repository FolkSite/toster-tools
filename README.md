...
1. Живое обновление ответов и комментариев к вопросу :clap:
2. Левый сайдбар обновляется в реалтайме. Выводится список новых уведомлений.
3. Добавляет возможность отправки ответа или комментария нажатием комбинации <kbd>Ctrl+Enter</kbd>
4. Добавляет возможность форматировать отступы клавишами <kbd>Tab/Shift+Tab</kbd>
5. Добавляет возможность скрывать правый сайдбар сайта
6. Добавляет возможность скрывать верхнюю панель со ссылками ТМ
7. Быстрый переход на страницу добавления нового вопроса и на страницу трекера
8. Проверка новых уведомлений (опция и интервал проверки включается в настройках)
